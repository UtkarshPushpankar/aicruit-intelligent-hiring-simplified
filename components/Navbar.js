...
const Navbar = () => {
    return (
        <nav className='navbar border max-w-[40vw] m-auto border-gray-300 h-[9vh] rounded-xl mt-10 bg-white shadow-2xl navbar flex items-center justify-between '>
