...
const messages = () => {
    ...
    return (
        <div className="profile-container flex h-screen">
            ...
            <div className="main w-[84vw] flex flex-col items-center gap-4">
                ...
                <div className="notification-box flex flex-col gap-4 items-center w-[75%] h-[75%] border-2 border-gray-300 rounded-xl m-10 p-6">
                    <div className="notification border-2 border-gray-300 w-[98%] h-[10vh] rounded-lg">
